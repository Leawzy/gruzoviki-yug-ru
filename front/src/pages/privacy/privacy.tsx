...
function Privacy() {
    return (
        <BaseLayout>
            <div>
                <h1>1. Политика в отношении обработки персональных данных</h1>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        получить о посетителях веб-сайта https://gruzoviki-yug.ru.
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        интернет по сетевому адресу https://gruzoviki-yug.ru.
                    </li>
                    <li>
