            ...
            <div>
                ...
                <ul>
                    <li>
                        ...
                        безопасности персональных данных, предпринимаемые ИП "Грузовики-Юг" (далее —
                        Оператор).
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <a className="privacyLink" href="https://грузовики-юг.рф">
                            https://грузовики-юг.рф
                        </a>
                        .
                    </li>
                </ul>
                <h1 className="privacyTitle"> 2. Основные понятия, используемые в Политике </h1>
                <ul>
                    <li>
                ...
                <h1 className="privacyTitle">3. Основные права и обязанности Оператора</h1>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        требованиями Закона о персональных данных; — сообщать в уполномоченный орган
                        по защите прав субъектов персональных данных по запросу этого органа
                        ...
                        Политике в отношении обработки персональных данных; — принимать правовые,
                ...
                <ul>
                    <li>
                        ...
                        получения установлен Законом о персональных данных; — требовать от оператора
                        ...
                        прав; — выдвигать условие предварительного согласия при обработке
                    ...
                    <li>
                        ...
                        изменении) своих персональных данных. 4.3. Лица, передавшие Оператору
                        недостоверные сведения о себе, либо сведения о другом субъекте персональных
                        данных без согласия последнего, несут ответственность в соответствии с
                        законодательством РФ.
                    </li>
                </ul>
                <h1 className="privacyTitle">5. Принципы обработки персональных данных </h1>
                <ul>
                    <li>
                ...
                <h1 className="privacyTitle">
                    6. Цели обработки персональных данных Цель обработки предоставление доступа
                    Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте
                    ...
                    месту пребывания Правовые основания уставные (учредительные) документы Оператора
                ...
                <h1 className="privacyTitle">7. Условия обработки персональных данных</h1>
                <ul>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        уведомление на адрес электронной почты Оператора admin@gruzoviki-yug.ru с
                    ...
                    <li>
                        ...
                        Оператора admin@gruzoviki-yug.ru с пометкой «Отзыв согласия на обработку
                        персональных данных».
                    </li>
                    <li>
                ...
                <h1 className="privacyTitle">10. Трансграничная передача персональных данных </h1>
                <ul>
                    <li>
                ...
                <h1 className="privacyTitle">
                    11. Конфиденциальность персональных данных Оператор и иные лица, получившие
                ...
                <h1 className="privacyTitle">12. Заключительные положения</h1>
                <ul>
                    <li>
                        ...
                        Оператору с помощью электронной почты admin@gruzoviki-yug.ru.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        Интернет по адресу{' '}
                        <a className="privacyLink" href="https://грузовики-юг.рф/privacy/privacy">
                            https://грузовики-юг.рф/privacy/privacy.
                        </a>
                    </li>
                </ul>
            </div>
