            ...
            <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0"
                ...
                <tr>
                    <td>
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td>
                                    <table style="width: 100%; border: 1px solid #ededed">
                                        <thead>
                                        <tr>
                                            <th>Наименование</th>
                                            <th>Цена, ₽</th>
                ...
                <tr>
                    <td style="text-align:center;">
                        <p style="font-size:14px; color:#455056bd; line-height:18px; margin:0 0 0; padding-bottom: 15px;">
                            &copy; <strong>грузовики-юг.рф</strong>
                        </p>
                    </td>
                </tr>
            </table>
